...
namespace RabbitMQ.In.Practice.Exercises {
    public class PublisherTransactionExercise : Exercise {
        private const string EXCHANGE_NAME = "ex.publisher.transaction";
        private const string QUEUE_NAME = "q.publisher.transaction";
        ...
        public PublisherTransactionExercise(ChannelFactory channelFactory)
            : base(channelFactory) { }

        public override int Code => 10;

        public override string Description => "Publisher Transaction Sample";
        ...
        public override int Run(TextReader input, TextWriter output) {
            ...
            // but from the perspective of the publisher.
        ...
        private async Task ProducerAsync(TextWriter output, CancellationToken cancellationToken) {
            ...
            // start the transaction from the publisher.
            channel.TxSelect();
            ...
            // commit the transaction from the publisher.
            channel.TxCommit();
